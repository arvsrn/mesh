<script lang="ts">
    ...
    let main: SVGElement;
    export let svgWidth: number = 700;
    export let svgHeight: number = 393.75;
...
<main style="width: {svgWidth}px; height: {svgHeight}px;">
    ...
    <main class="buttons">
        ...
        <IconButton handler={() => showingHandles = !showingHandles} label={showingHandles ? "Hide handles" : "Show handles"}>
            {#if showingHandles}
        ...
        <IconButton handler={generate} label="Regenerate gradient">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
